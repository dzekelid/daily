...
- name: IEX Trading API Corporate Actions
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/daily/master/_listings/iex/refdatadailylistsymboldirectory-get-openapi.md
- name: IEX Trading API Next Day Ex Date
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/daily/master/_listings/iex/refdatadailylistnextdayexdate-get-openapi.md
- name: IEX Trading API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/daily/master/_listings/iex/openapi.md
x-common:
